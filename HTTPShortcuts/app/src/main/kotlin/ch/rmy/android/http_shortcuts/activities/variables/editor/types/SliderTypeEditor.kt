...
fun SliderTypeEditor(
    ...
    TextField(
        ...
        isError = viewState.maxValue <= viewState.minValue,
        supportingText = if (viewState.maxValue <= viewState.minValue) {
            {
    ...
    TextField(
        ...
        isError = viewState.stepSize <= 0,
        supportingText = if (viewState.stepSize <= 0) {
            {
